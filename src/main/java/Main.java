...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Ram ram : computerMediumPc.getRamConfiguration().searchByName("hyperx")){ // ищем в computerMediumPc оперативу с именем hiperx
...
//        System.out.println(new Urllink().getEmptyLinesCount());

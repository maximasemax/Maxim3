...
public class ComputerCreator {
    ...
    public Computer createHiperpc() {
        ...
        return new PersonalComputer("hiperpc", mouse, videoAdapter, cpu, keyboard, motherboard,ramConfiguration );

    }
    // FIXME Нормальные имена переменных
    public Computer createOfficePc() {
        ...
        return new PersonalComputer("OfficePc", mouse, videoAdapter, cpu, keyboard, max4, ramConfiguration);
    ...
    public Computer createMediumPc() {
        ...
        //FiXME RETURN исправить
        PersonalComputer number1 = new PersonalComputer("MediumPc", max, max1, max2, max3, max4, ramConfiguration);
        return number1;
    }
